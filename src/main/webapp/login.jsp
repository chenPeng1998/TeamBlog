...
<head>
  ...
  <link href="<%=path%>/view/css/login.css" rel='stylesheet' type='text/css' />
  <script src="<%=path%>/view/js/jquery-2.1.4.min.js"></script>
  <script src="<%=path%>/view/js/layer/layer.js"></script>
</head>
<body>
...
<div class="login-form">
  ...
  <div class="clear"> </div>
  <div class="avtar"><img src="<%=path%>/view/images/avtar.png" /></div>
  <form id="login-form" action="view/index.jsp" method="post" onsubmit="return checkLoginForm()">
    <div class="key">
